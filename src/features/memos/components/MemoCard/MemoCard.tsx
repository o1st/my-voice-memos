...
export const MemoCard: React.FC<MemoCardProps> = memo(({ memo, onClick }) => {
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: intentionally using div for card layout
		// biome-ignore lint/a11y/noStaticElementInteractions: intentionally using div for card layout
		<div
		...
		>
			<div className="flex-1 min-h-0">
				...
				<p className="text-gray-600 text-sm line-clamp-3">{memo.description}</p>
			</div>
